...
['name' => 'Elin Eriksson', 'id' => 5, 'img' => 'img/prof5.png', 'quote' => 'Thank God I didn’t go to school Thank God I didn’t end up Just like you
'],
];
...
$articles =[
    ...
    'date' => '2018-10-15', 'author' => 'Erik Arvidsson', 'id' => '1', 'img' => 'img/1.jpg'],
    ['title' => 'Andra artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-15', 'author' => 'Arvid Eriksson', 'id' => '2', 'img' => 'img/2.jpg'],
    ['title' => 'Tredje artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-15', 'author' => 'Arvid Arvidsson', 'id' => '3', 'img' => 'img/3.jpg'],
    ['title' => 'Fjäred artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-13', 'author' => 'Erik Arvidsson', 'id' => '4', 'img' => 'img/4.jpg'],
    ['title' => 'Femte artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-15', 'author' => 'Arvid Eriksson', 'id' => '5', 'img' => 'img/5.jpg'],
    ['title' => 'Sjunde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-08-15', 'author' => 'Erik Arvidsson', 'id' => '6', 'img' => 'img/6.jpg'],
    ['title' => 'Åttonde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-12', 'author' => 'Erik Eriksson', 'id' => '7', 'img' => 'img/7.jpg'],
    ['title' => 'Nionde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-15', 'author' => 'Erik Arvidsson', 'id' => '8', 'img' => 'img/8.jpg'],
    ['title' => 'Nionde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-11-15', 'author' => 'Elin Eriksson', 'id' => '9', 'img' => 'img/9.jpg'],
    ['title' => 'Nionde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-05-15', 'author' => 'Vida Arvidsson', 'id' => '10', 'img' => 'img/8.jpg'],
    ['title' => 'Nionde artikeln', 'content' => file_get_contents(__DIR__.'/content/article2.txt'),
    'date' => '2018-10-13', 'author' => 'Elin Arvidsson', 'id' => '11', 'img' => 'img/8.jpg'],
];
